          ...
          <ul>
            ...
            {notf == false ?
              <li onClick={handleNotification} className='icons' >
                ...
                <a style={{paddingLeft:"3%", paddingTop:"1%"}}>Notifications</a>
              </li> :
              <li onClick={handleNotification} className='icons' >
